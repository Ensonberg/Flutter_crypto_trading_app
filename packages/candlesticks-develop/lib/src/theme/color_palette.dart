...
class DarkColorPalette {
  ...
  static const primaryGreen = Color(0xFF00C076);
  static const secondaryGreen = Color(0xFF00C076);
  static const primaryRed = Color(0xFFFF6838);
  static const secondaryRed = Color(0xFFFF6838);
