...
class ChartDataStreamNotifier extends StreamNotifier<KlineEvent> {
  @override
  Stream<KlineEvent> build() async* {
    final interval = ref.watch(intervalProvider);

    final channel = IOWebSocketChannel.connect(
        'wss://fstream.binance.com/ws/btcusdt@kline_$interval');
...
final chatDataProvider =
    StreamNotifierProvider<ChartDataStreamNotifier, KlineEvent>(
